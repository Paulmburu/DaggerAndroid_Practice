...
class Resource<T>(@field:NonNull @param:NonNull val status: Status, @field:Nullable @param:Nullable val data: T?, @field:Nullable @param:Nullable val message: String?) {
